window.onload = function(){
  ...
  function calcDashoffset(scrollY, element, length) {
    ...
    function fade(scrollY){
      ...
      var calcul = document.querySelector(".calcul").offsetTop;
      var survay = document.querySelector(".survay").offsetTop;
      ...
      if((scrollY) -100> calcul){
        document.querySelector('.calcul').style.animation='fade-in 0.3s linear .0s both';
      }
      else{
        document.querySelector('.calcul').style.animation='fade-out 0.3s linear .0s both';
      }
      if((scrollY) -100> survay){
        document.querySelector('.survay').style.animation='fadeInLeft 0.3s linear .0s both';
      }
      else{
        document.querySelector('.survay').style.animation='fadeOutLeft 0.3s linear .0s both';
      }
      if((scrollY) -100> myweb){
        document.querySelector('.myweb').style.animation='fade-in 0.3s linear .0s both';
      }
      else{
        document.querySelector('.myweb').style.animation='fade-out 0.3s linear .0s both';
      }
